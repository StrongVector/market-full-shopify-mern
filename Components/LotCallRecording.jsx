...
<div className='flex flex-col items-start justify-start w-full gap-2 bg-white p-6  rounded-2xl'>
<p className='font-medium text-[20px]  mb-6'>
            تسجيل نداء فقدان عربيه أو عربيه مجهولة
        </p>
    <p className='justify-self-end text-right text-[18] font-medium'>التصنيف</p>
