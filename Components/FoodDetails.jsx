        ...
        <section className='flex flex-col items-center justify-center gap-3'>
            <div className='flex flex-col items-center justify-center gap-3 text-lg'>
                ...
                <p className='flex justify-center items-center gap-2'>
                    <span>{data.rate}</span><span><MdStarRate className='text-yellow-400'/></span>
                </p>
                <p className='text-sm text-slate-600 font-light'>{data.description}</p>
                <p className='text-blue-600'>{`${data.price}$`}</p>
                

            </div>
            <div className="">
            <button disabled = {isDesible}  onClick={()=>hundleBuy(data)} className='  px-4 text-lg font-semibold py-1
